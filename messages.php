...
// Start Page
    ...
    <table border="0" cellpadding="4" cellspacing="0" width="737">
        <tr>
            <td class=colhead align=left><?php echo $lang_messages['col_search_message'] ?></td>
        </tr>
        <tr>
            <td class=toolbox align=center><?php echo insertJumpTo($mailbox); ?></td>
        </tr>
    </table>
        ...
        <form action="messages.php" method="post">
            ...
            <table border="0" cellpadding="4" cellspacing="0" width="737">
                <tr>
                    ...
                    ?>
                    <td width="1%" class="colhead" align="center"><img class="time" src="pic/trans.gif" alt="time"
                                                                       title="<?php echo $lang_messages['col_date'] ?>"/>
                    </td>
...
// Get Sender Username
                ...
                ?>
                <tr class="colhead">
                    <td colspan="5" align="right" class="colhead"><input class=btn type="button"
                                                                         value="<?php echo $lang_messages['input_check_all']; ?>"
                                                                         onClick="this.value=check(form,'<?php echo $lang_messages['input_check_all'] ?>','<?php echo $lang_messages['input_uncheck_all'] ?>')">
                        <input type="hidden" name="unread"
                               value="<?php echo($_GET["unread"] ? $_GET["unread"] : ""); ?>">
                        ...
                        <input class=btn type="submit" name="delete"
                               value=<?php echo $lang_messages['submit_delete'] ?>>
                        <?php
                        if ($mailbox != PM_SENTBOX) {
...
print("</form>");
     */ ?>
        ...
        <tr>
            <td class=toolbox colspan=5>
                <div align="center"><img class="unreadpm" src="pic/trans.gif" alt="Unread"
                                         title="<?php echo $lang_messages['title_unread'] ?>"/><a
                            href="messages.php?action=viewmailbox&box=<?php echo $mailbox ?>&unread=yes"><?php echo $lang_messages['text_unread_messages'] ?></a>
                    <img class="readpm" src="pic/trans.gif" alt="Read"
                         title="<?php echo $lang_messages['title_read'] ?>"/><a
                            href="messages.php?action=viewmailbox&box=<?php echo $mailbox ?>&unread=no"><?php echo $lang_messages['text_read_messages'] ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="messages.php?action=editmailboxes"><b><?php echo $lang_messages['text_mailbox_manager'] ?>
                    </a></b></div>
            </td>
        </tr></table>
        <?php
...
// Display message
    ...
    <table width="737" border="0" cellpadding="4" cellspacing="0">
        ...
        <tr>
            ...
            <td class="rowfollow" align="left"><?php echo gettime($added, true, false) ?>
                &nbsp;&nbsp;<?php echo $unread ?></td>
        </tr>
        <tr>
...
<input type=\"submit\" name=\"move\" value=" . $lang_messages['submit_move_to'] . "><select name=\"box\"><option value=\"1\">" . $lang_messages['text_inbox'] . "</option>");
            ...
            <td align="right"><font color=white>[ <a
                            href="messages.php?action=deletemessage&id=<?php echo $pm_id ?>"><?php echo $lang_messages['text_delete'] ?></a>
                    ]<?php echo $reply ?> [ <a

                            href="messages.php?action=forward&id=<?php echo $pm_id ?>"><?php echo $lang_messages['text_forward_pm'] ?></a>
                    ]</font></td>
        </tr>
    </table>
    <?php
    ...
    <table border="0" cellpadding="4" cellspacing="0" width="737">
        <form action="takemessage.php" method="post">
            ...
            <tr>
                ...
                <td class="rowfollow" align=left><input type="text" name="subject" value="<?php echo $subject ?>"
                                                        style="width: 500px"></td>
            </tr>
            <tr>
                <td class="rowhead" align="right" valign="top">
                    <nobr><?php echo $lang_messages['row_message'] ?></nobr>
                </td>
                <td class="rowfollow" align=left><textarea name="body" style="width: 500px"
                                                           rows="8"></textarea><br/><?php echo $body ?></td>
            </tr>
            <tr>
                <td class=toolbox colspan="2" align="center"><input class=checkbox type="checkbox" name="save"
                                                                    value="yes"<?php echo $CURUSER['savepms'] == 'yes' ? " checked" : "" ?>><?php echo $lang_messages['checkbox_save_message'] ?>
                    &nbsp;
...
function insertJumpTo($selected = 0)
{
    ...
    ?>
    <form action="messages.php" method="get">
        <input type="hidden" name="action" value="viewmailbox"><?php echo $lang_messages['text_search'] ?>
        &nbsp;&nbsp;<input id="searchinput" name="keyword" type="text"
                           value="<?php echo htmlspecialchars($_GET['keyword']) ?>" style="width: 200px"/>
