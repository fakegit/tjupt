...
if ($action == "edit") {
    ...
    $res = sql_query("SELECT * FROM poll_questions WHERE id = $pollid LIMIT 1") or sqlerr(__FILE__, __LINE__);
...
$res = sql_query("SELECT question, added_at FROM poll_questions ORDER BY added_at DESC LIMIT 1") or sqlerr();
